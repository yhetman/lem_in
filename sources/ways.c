...
/*   Updated: 2019/08/16 18:38:17 by yhetman          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		overflow_of_ants(t_lemin *lemin, t_send *sender, int to_subtract)
{
	int	i;
...
bool	case_one_ant(t_lemin *lemin, t_send *sender)
{
	int	i;
...
int		get_nb_lines(t_send *sender, t_lemin *lemin)
{
	int	ret;
	int	i;
...
int		reorganize_ants(t_lemin *lemin, t_send *sender, int to_add)
{
	int	i;
	int	lines;
